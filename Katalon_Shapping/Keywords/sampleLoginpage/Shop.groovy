...
public class Shop {
	...
	def static void addToCart(String productName, String urlProduct){
		...
		WebUI.verifyElementPresent(findTestObject('Object Repository/Shopping page/btnProceed'), GlobalVariable.waitPresentTimeout)
		//WebUI.click(findTestObject('Object Repository/Shopping page/btnProceed'))
	}


	@Keyword
	def static void applyCouponAndAddToCart(String productName, String urlProduct, String coupan){
		navigatetoDetailsPage(productName, urlProduct)
		WebUI.delay(5)

		WebUI.waitForElementNotPresent(findTestObject('Object Repository/Shopping page/btnAddToCart'), GlobalVariable.waitPresentTimeout)
		WebUI.click(findTestObject('Object Repository/Shopping page/btnAddToCart'))

		WebUI.waitForElementPresent(findTestObject('Object Repository/Shopping page/btnViewCart'), GlobalVariable.waitPresentTimeout)
		WebUI.click(findTestObject('Object Repository/Shopping page/btnViewCart'))

		WebUI.setText(findTestObject('Object Repository/Shopping page/txtCoupan'), coupan)
		WebUI.click(findTestObject('Object Repository/Shopping page/btnApply'))
	}
	...
	def static void applyCouponAndAddToCartWithGlobalVariable(){
		applyCouponAndAddToCart(GlobalVariable.productName, GlobalVariable.urlProduct, GlobalVariable.coupan)
	}
}
