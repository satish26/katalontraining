...
public class Checkout {
	...
	@Keyword
	def static void CheckoutShoplistpage(String firstname, String lastname, String companyname, String Country, String address, String postcode, String city, String Phone, String email, String ordernotes){
